...
CREATE TABLE IF NOT EXISTS checkins (
  ...
  checkin_business_date DATE NULL,
  checked_out_at DATETIME NULL,
  checkout_business_date DATE NULL,
...
CREATE TABLE IF NOT EXISTS account_movements (
  ...
  KEY ix_account_movements_business_date (business_date, occurred_at),
  KEY ix_account_movements_operational_day (operational_day_id),
